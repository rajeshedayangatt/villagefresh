                    ...
                    <div className="col-md-4">
                       <div className="card account-left">
                          <div className="user-profile-header">
                             <img alt="logo" src="https://askbootstrap.com/preview/groci/img/user.jpg" />
                          ...
                          <div className="list-group">
                             ...
                             <a href="my-address.html" className="list-group-item list-group-item-action active"><i aria-hidden="true" className="mdi mdi-map-marker-circle"></i>  My Address</a>
                             <a href="https://askbootstrap.com/preview/groci/wishlist.html" className="list-group-item list-group-item-action"><i aria-hidden="true" className="mdi mdi-heart-outline"></i>  Wish List </a>
                          ...
                          <div className="widget">
                             ...
                             <form>
                                <div className="row">
                                   <div className="col-sm-12">
                                      <div className="form-group">
                                         <label className="control-label">Company <span className="required">*</span></label>
                                         <input className="form-control border-form-control" value="Osahan Company Ltd." placeholder="" type="text" />
                                      </div>
                                   </div>
                                </div>
                                <div className="row">
                                ...
                                <div className="row">
                                   <div className="col-sm-12">
                                      <div className="form-group">
                                         <label className="control-label">Address 1 <span className="required">*</span></label>
                                ...
                                <div className="row">
                                   <div className="col-sm-12">
                                      <div className="form-group">
                                         <label className="control-label">Address 2 <span className="required">*</span></label>
                                         <textarea className="form-control border-form-control"></textarea>
                                      </div>
                                   </div>
                                </div>
                                <div className="row">
                                   <div className="col-sm-12">
                                      <div className="custom-control custom-checkbox mb-3">
                                         ...
                                         <label className="custom-control-label" for="customCheck1">Same as Contact Address</label>
                                      </div>
                                   </div>
                                </div>
                                <div className="row">
                                   <div className="col-sm-12 text-right">
                                      ...
                                      <button type="button" className="btn btn-success btn-lg"> Update Address </button>
                                   </div>
                                </div>
                             </form>
                          </div>
